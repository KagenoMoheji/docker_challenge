...
//     ValueAdvanced,
//     HelpOption,
// } from "~~/displayhtml/src/main/types/typesCliParser";
// import { CliParser } from "~~/displayhtml/src/main/modules/cliParser";
import {
    CliParams,
    OptionAdvanced,
    ValueAdvanced,
...
if (require.main === module) {
    ...
    server.listen(cliParams.port.data, cliParams.host.data, () => {
        console.log(
