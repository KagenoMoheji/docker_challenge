...
export const SampleCSSPropOfStyledComponent = (): JSX.Element => {
  const [count, setCount] = useState(0);

  return (
    <div className="comp-samplecsspropofstyledcomponent" css={scopedStyles.cssApp}>
      <div>
      ...
      <div className="card">
        ...
        <p className="text-blue-300">
          Edit <code>src/SampleCSSPropOfStyledComponent.tsx</code> and save to test HMR
        </p>
      </div>
