                ...
                */}
                <li className="group h-full relative px-4 hover:bg-gray-500 mdx:w-full mdx:h-14 mdx:px-0">
                  ...
                  */}
                  ...
                  {/* <div className="dropdown-content z-100 bg-gray-300 absolute top-full right-0 w-80 mdn:group-hover:block hidden mdx:w-full break-words mdx:[&.dropdown-active]:block"> */}
                  <div className={`dropdown-content z-100 bg-gray-300 absolute top-full right-0 w-80 h-0 overflow-hidden mdn:group-hover:h-auto mdn:group-hover:overflow-visible mdx:w-full break-words mdx:[&.dropdown-active]:h-auto mdx:[&.dropdown-active]:overflow-visible ${dropdownActive}`}>
