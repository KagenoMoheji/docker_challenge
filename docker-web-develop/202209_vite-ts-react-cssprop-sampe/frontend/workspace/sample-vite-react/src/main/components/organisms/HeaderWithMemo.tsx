...
export const Header = (): JSX.Element => {
  ...
  // MEMO: useCallback入れてみたけどあんま変わった様子無い…
  const onClickHumb = useCallback((eve: React.MouseEvent<HTMLDivElement, MouseEvent>): void => {
    // console.log(eve);
  ...
  // MEMO: useCallback入れてみたけどあんま変わった様子無い…
  const onClickDropdown = useCallback((eve: React.MouseEvent<HTMLDivElement, MouseEvent>): void => {
    // console.log(eve);
...
// MEMO: React.memo入れてみたけどあんま変わった様子無い…
export const HeaderWithMemo = memo(Header);
HeaderWithMemo.displayName = "HeaderWithMemo";
